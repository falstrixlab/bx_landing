...
$reviewTitle = bxsea_plain_text($homeinfluencertitle[0]['masterdesc_title_en'] ?? 'INFLUENCER REVIEW');
...
$normalizeHomeLabel = static function (?string $label, string $fallback = ''): string {
    ...
    $replacements = [
        'Ticket Fee' => 'Ticket Prices',
        'Oceanarium Map' => 'Oceanarium Maps',
    ];
...
foreach (array_slice($hometestimoni ?? [], 0, 6) as $slide) {
  $appendReviewSlide(
    $reviewSlides,
    bxsea_plain_text($slide['testimoni_desc_en'] ?? ($slide['testimoni_desc'] ?? '')),
...
foreach (array_slice($homeinfluencer ?? [], 0, 6) as $slide) {
  $appendReviewSlide(
    $reviewSlides,
    bxsea_plain_text($slide['homeinfluencer_review_en'] ?? ($slide['homeinfluencer_review'] ?? '')),
...
if (count($reviewSlides) < 2) {
    $reviewSlides = [
        [
            'text' => 'This is a complete holiday package because it feels comfortable and exciting. I really love visiting BXSea, and my family will definitely come back again.',
            'name' => 'Asri Welas',
            'image' => base_url('assets/landing/image/testi1.jpg'),
        ],
        [
            'text' => 'I am happy to visit BXSea because it is close to home, so I can bring my family along. I want to come back again when there are even more new attractions!',
            'name' => 'Aiman Ricky',
            ...
            <div class="row top-section">
                <div class="shortcut-btn">
                    <div class="btn-rounded">
                        <a href="<?= base_url('/en/tiket/harga'); ?>">
                            <img src="<?= $shortcutTicketAsset; ?>" alt="">
                            <p>Book Tickets</p>
                        </a>
                        <a href="<?= base_url('/en/kunjungan/denah'); ?>">
                        ...
                        <a href="<?= base_url('/en/kunjungan/informasi-pengunjung'); ?>">
                            <img src="<?= $shortcutVisitorAsset; ?>" alt="">
                            <p>Visitor Info</p>
                        </a>
                        <a href="<?= base_url('/en/kunjungan/hubungi-kami'); ?>">
                ...
                <div class="owl-carousel owl-theme owl-oceanarium-tours">
                    ...
                    <div class="oceanarium-tours-image">
                        <div class="image-banner-owl-oceanariumtours">
                            <img src="<?= bxsea_asset_url('fiturslide', $hfs['homefitureslide_pict'] ?? '', 'assets/landing/image/rajaampat-carousel.png'); ?>" alt="<?= esc($hfs['homefiturslide_title_en'] ?? $hfs['homefiturslide_title'] ?? 'BXSea'); ?>">
                        ...
                        <div class="overlay-oceanariumtours">
                            ...
                            <div class="desc-overlay-oceanariumtours">
                                <h4><?= esc($normalizeHomeLabel($hfs['homefiturslide_title_en'] ?? $hfs['homefiturslide_title'] ?? '', 'BXSea')); ?></h4>
                                <p><?= esc(bxsea_plain_text($hfs['homefiturslide_shortdesc_en'] ?? $hfs['homefiturslide_shortdesc'] ?? '')); ?></p>
                            </div>
                            <div class="btn-overlay-oceanariumtours">
                                <a href="<?= base_url('/en/journey/journey-utama'); ?>">Explore All Zones</a>
        ...
        <a class="box-additional-exp" href="<?= base_url('/en/tiket/pengalaman-premium'); ?>">
            <div class="image-box-additional-exp">
                ...
                <div class="desc-box-additional-exp">
                    ...
                    <div class="box-white">
                        <h4><?= esc($exp['experience_title_en'] ?? $exp['experience_title'] ?? 'Experience'); ?></h4>
                        <p><?= esc(substr(bxsea_plain_text($exp['experience_desc_en'] ?? $exp['experience_desc'] ?? ''), 0, 100)); ?></p>
                    </div>
                </div>
            </div>
        </a>
    ...
    <div class="flex-show">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            ...
                            <li class="splide__slide">
                                <a href="<?= base_url('/en/journey/pertunjukan'); ?>">
                                    <img class="img-fluid" src="<?= bxsea_asset_url('show', $sh['show_poster'] ?? '', 'assets/landing/image/bxsea_image_regular_show.png'); ?>" alt="<?= esc($sh['show_title_en'] ?? $sh['show_title'] ?? 'Show'); ?>">
                                </a>
                            </li>
                            <?php endforeach; ?>
                        </ul>
        ...
        <div class="box-title-show-ocean">
            ...
            <div class="btn-show-schedule">
                <a href="<?= base_url('/en/journey/pertunjukan'); ?>">View Show Schedule <img class="arrow-right-btn-show-schedule" src="<?= base_url('assets/landing/'); ?>image/arrow-right-white.png" alt=""></a>
            </div>
        </div>
    </div>
</section>
...
<section class="event">
    <div class="left-grid">
        ...
        <div class="desc-event">
            <p>Our events return regularly!</p>
        </div>
    </div>
    <div class="right-grid-box">
            ...
            <a class="box-event" href="<?= $promoHref; ?>" <?= !empty($promoItem['promotion_link']) ? 'target="_blank" rel="noopener noreferrer"' : ''; ?>>
                <div class="image-box-event">
                    ...
                    <div class="desc-box-event">
                        <div class="box-white">
                            <h4><?= esc($promoItem['promotion_title_en'] ?? $promoItem['promotion_title'] ?? 'Event'); ?></h4>
                            <p><?= esc(substr(bxsea_plain_text($promoItem['promotion_desc_en'] ?? $promoItem['promotion_desc'] ?? ''), 0, 130)); ?>...</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="cta-ig-tiktok-event">
            <p><img src="<?= base_url('assets/landing/'); ?>image/arrow-right-event.png" alt=""> Visit our <a href="https://instagram.com/bxsea_official?igshid=OGQ5ZDc2ODk2ZA==" target="_blank" rel="noopener noreferrer">Instagram</a> and <a href="https://www.tiktok.com/@bxsea_official?_t=8hl0H4KuNA0&_r=1" target="_blank" rel="noopener noreferrer">TikTok</a> for the latest updates</p>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="review-influencer">
    ...
    <div class="container">
        ...
        <div class="splide review-influencer-splide" role="group" aria-label="">
            <div class="splide__track">
                <ul class="splide__list">
                    <?php foreach ($reviewSlides as $influencer): ?>
                    <li class="splide__slide">
                        <div class="activies-said">
                            <p><?= esc($influencer['text']); ?></p>
                        </div>
                        <div class="image-activies">
                            <img src="<?= esc($influencer['image']); ?>" alt="<?= esc($influencer['name'] ?? 'Reviewer'); ?>">
                            <p class="name-activies"><?= esc($influencer['name'] ?? ''); ?></p>
                        </div>
                    </li>
                    <?php endforeach; ?>
                </ul>
...
<section class="Tenantus home-tenant-section">
        ...
        <div class="splide__track">
            <ul class="splide__list">
                ...
                <li class="splide__slide">
                        ...
                        <?php if (!empty($td['tenant_location_en'] ?? $td['tenant_location'] ?? '')): ?>
                        <p><span class="bold-text">Location :</span> <?= esc($td['tenant_location_en'] ?? $td['tenant_location'] ?? ''); ?></p>
                        <?php endif; ?>
                </li>
                <?php endforeach; ?>
            </ul>
    ...
    <div class="btn-find-out-more-tenants">
        <a href="<?= base_url('/en/kunjungan/tenant');?>">Explore More <img class="arrow-btn-find-out-more-tenants" src="<?= base_url('assets/landing/');?>image/arrow-right-white.png" alt=""></a>
    </div>
</section>
<?php endif; ?>

<?php if (!empty($articletop) && $featuredArticle): ?>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4 left-grid">
            ...
            <div class="cta-news">
                <div class="latest-news">
                    <a href="<?= base_url('/en/berita');?>">Latest News <img class="arrow-right-latest-news" src="<?= base_url('assets/landing/');?>image/arrow-right-white.png" alt=""></a>
                </div>
                <div class="conversation-stories">
                    <a href="<?= base_url('/en/berita');?>">Conservation Stories <img class="arrow-right-conversation-stories" src="<?= base_url('assets/landing/');?>image/arrow-right-white.png" alt=""></a>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4 center-grid text-center">
            <a href="<?= base_url('/en/berita/detail/' . $featuredArticle['article_id']); ?>">
                <img src="<?= bxsea_asset_url('article', $featuredArticle['article_pict'] ?? '', 'assets/landing/image/bxsea_image_information.png'); ?>" class="img-fluid" alt="<?= esc($featuredArticle['article_title_en'] ?? $featuredArticle['article_title'] ?? 'News'); ?>">
            </a>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4 right-grid d-flex flex-column justify-content-end">
            <div class="title-news">
                <h1><?= esc($featuredArticle['article_title_en'] ?? $featuredArticle['article_title'] ?? 'News'); ?></h1>
            </div>
            <div class="desc-news">
                <p><?= esc(substr(bxsea_plain_text($featuredArticle['article_desc_en'] ?? $featuredArticle['article_desc'] ?? ''), 0, 220)); ?>...</p>
            </div>
            <div class="date-news">
                <p><?= esc($featuredArticle['article_created_date']); ?></p>
            </div>
            <div class="read-more-news">
                <a href="<?= base_url('/en/berita/detail/' . $featuredArticle['article_id']); ?>">Read More <img class="arrow-right-read-more-news" src="<?= base_url('assets/landing/');?>image/arrow-right-white.png" alt=""></a>
            </div>
        </div>
    </div>
</section>
...
<section class="ticketing home-ticketing">
    <div class="container">
        ...
        <div class="head-title-ticketing">
            ...
            <p>Get a BXSea ticket to get access to explore a variety of unique marine species that you have never seen in Indonesia.</p>
        </div>
        <div class="box-nav-ticketing">
            ...
            <a class="link-ourwork<?= $index === 0 ? ' active' : ''; ?>" data-target="#work<?= $tcat['ticketcat_id']; ?>" href="#work<?= $tcat['ticketcat_id']; ?>">
                <div class="title-ourwork">
                    <p><?= esc($tcat['ticketcat_name_en'] ?? $tcat['ticketcat_name']); ?></p>
                </div>
            </a>
            <?php endforeach; endif; ?>
        </div>
        ...
        <div class="ticket-tab-panel<?= $index === 0 ? ' is-active' : ''; ?>" id="work<?= $tcat['ticketcat_id']; ?>">
            <div class="title-lityhide">
                <p>
                      <?php if ((int) $tcat['ticketcat_id'] === 1): ?><?= esc(bxsea_plain_text($homedescticketreguler[0]['masterdesc_desc_en'] ?? 'Max. purchase of 10 tickets per transaction')); ?>
                      <?php else: ?><?= esc(bxsea_plain_text($homedescticketgroup[0]['masterdesc_desc_en'] ?? 'Minimum purchase of 20 tickets per transaction')); ?><?php endif; ?>
                </p>
            </div>
            <div class="splide <?= (int) $tcat['ticketcat_id'] === 1 ? 'card-ticketing-splide' : 'card-ticketing-splide2'; ?>" role="group" aria-label="">
                <div class="splide__track">
                    <ul class="splide__list">
                        <?php
                            $ticketSource = 'ticketregular';
                            if ($tcat['ticketcat_id'] == 2) $ticketSource = 'ticketgroup';
                        ?>
                        <?php foreach ($$ticketSource as $tkt): ?>
                        <li class="splide__slide box-card-ticketing">
                            <div class="card-ticketing">
                                ...
                                <div class="image-card-ticketing">
                                    <img src="<?= bxsea_asset_url('ticket', $tkt['ticket_pict'] ?? '', 'assets/landing/image/bxsea-image-ticket-regular.png'); ?>" alt="<?= esc($tkt['ticket_title_en'] ?? $tkt['ticket_title'] ?? 'Ticket'); ?>">
                                </div>
                                    ...
                                    <div class="desc-card-ticketing">
                                        ...
                                        <div class="footer-card-ticketing">
                                            <div class="link-buy-card-ticketing">
                                                ...
                                                <a class="bg-blue-ticket" href="<?= esc($tkt['ticket_link']); ?>" target="_blank" rel="noopener noreferrer">Buy Now!</a>
                                                <?php else: ?>
                                                <a<?= (int) $tcat['ticketcat_id'] === 2 ? ' class="bg-blue-ticket"' : ''; ?> href="javascript:void(0)">Coming Soon</a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="splide klien-splide" role="group" aria-label="">
                <div class="splide__track">
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <img class="img-fluid" src="<?= bxsea_asset_url('partner', $partner['partner_pict'] ?? '', 'assets/landing/image/image-partner3.png'); ?>" alt="<?= esc($partner['partner_title'] ?? 'Partner'); ?>">
                        </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
    ...
    <div class="box-partnerships">
        <div class="container">
            ...
            <div class="desc-partnerships">
                <p>We are excited to build meaningful partnerships that support education, conservation, and unforgettable experiences at BXSea.</p>
            </div>
