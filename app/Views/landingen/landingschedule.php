          ...
          <div class="container top-bar-flex">
            <div class="right-topbar">
              ...
              <div class="dropdown">
                ...
                <div class="menu">
                    <li><a href="<?= base_url('id');?>">INDONESIA</a></li>
                </div>
              </div>
            </div>
          </div>
            ...
            <nav class="nav">
              <div class="container navbar__menu">
                  ...
                  <ul class="nav__list" id="nav-menu">
                    ...
                    <li class="dropdown__menu-"><div class="text-dropdown-menu"><p>Entrance Ticket</p><div class="arr-down"></div></div>
                        ...
                        <div class="megamenu">
                            <ul class="content">
                                ...
                                <li class="megamenu__item">
                                    <div class="megamenu__link">
                                        <a href="<?= base_url('/en/tiket/harga');?>">Ticket Prices</a>
                                    </div>
                                </li>
                                <li class="megamenu__item">
                                    <div class="megamenu__link">
                                        <a href="<?= base_url('/en/tiket/promosi');?>">Promotions</a>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <ul class="content">
                              ...
                              <li class="megamenu__item">
                                  <div class="megamenu__link">
                                      <a href="<?= base_url('/en/tiket/pengalaman-premium');?>">Premium Experiences</a>
                                  </div>
                              </li>
                              <li class="megamenu__item">
                                  <div class="megamenu__link">
                                      <a href="<?= base_url('/en/tiket/program-kunjungan-sekolah');?>">School Visit Program</a>
                                  </div>
                              </li>
                              <li class="megamenu__item">
                                <div class="megamenu__link">
                                    <a href="<?= base_url('/en/tiket/momen-istimewa');?>">Special Moments</a>
                                </div>
                            </li>
                          </ul>
                        </div>
                    ...
                    <li class="dropdown__menu-"><div class="text-dropdown-menu"><p>Explore</p><div class="arr-down"></div></div>
                      ...
                      <div class="megamenu">
                        <ul class="content">
                            ...
                            <li class="megamenu__item">
                                <div class="megamenu__link">
                                    <a href="<?= base_url('/en/journey/journey-utama');?>">Main Journey</a>
                                </div>
                            </li>
                            <li class="megamenu__item">
                              <div class="megamenu__link">
                                  <a href="<?= base_url('/en/journey/pertunjukan');?>">Show</a>
                              </div>
                          </li>
                        </ul>
                      </div>
                    ...
                    <li class="dropdown__menu-"><div class="text-dropdown-menu"><p>Visit</p><div class="arr-down"></div></div>
                      ...
                      <div class="megamenu">
                        <ul class="content">
                            ...
                            <li class="megamenu__item">
                                <div class="megamenu__link">
                                    <a href="<?= base_url('/en/kunjungan/jadwal-aquarium');?>">Aquarium Schedule</a>
                                </div>
                            </li>
                            <li class="megamenu__item">
                              <div class="megamenu__link">
                                  <a href="<?= base_url('/en/kunjungan/denah');?>">BXSea Map</a>
                              </div>
                          </li>
                            <li class="megamenu__item">
                                <div class="megamenu__link">
                                    <a href="<?= base_url('/en/kunjungan/panduan-aksesibilitas');?>">Accessibility Guide</a>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="content">
                          ...
                          <li class="megamenu__item">
                              <div class="megamenu__link">
                                  <a href="<?= base_url('/en/kunjungan/tenant');?>">Our Tenants</a>
                              </div>
                          </li>
                          <li class="megamenu__item">
                              <div class="megamenu__link">
                                  <a href="<?= base_url('/en/kunjungan/merchandise');?>">Merchandise</a>
                              </div>
                          </li>
                          <li class="megamenu__item">
                            <div class="megamenu__link">
                                <a href="<?= base_url('/en/kunjungan/faq');?>">FAQ</a>
                            </div>
                          </li>
                          <li class="megamenu__item">
                            <div class="megamenu__link">
                                <a href="<?= base_url('/en/kunjungan/hubungi-kami');?>">Contact Us</a>
                            </div>
                          </li>
                        </ul>
                      </div>
                    ...
                    <li><a href="<?= base_url('/en/berita');?>">Latest News</a></li>

                    <div class="contact">
                      <a href="https://ticket.bxsea.co.id/">Book Tickets</a>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-2 box-center">
                <div class="navbar-footer">
                  <h4>More Info</h4>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/tentang-kami');?>">About Us</a>
                  </div>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/kunjungan/tenant');?>">Our Tenants</a>
                  </div>
                  ...
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/berita');?>">Latest News</a>
                  </div>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/kunjungan/hubungi-kami');?>">Contact Us</a>
                  </div>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/kunjungan/partnership');?>">Partnership</a>
                  </div>
                </div>
              </div>
              <div class="col-lg-2 box-center">
                <div class="navbar-footer">
                  <h4>Policies</h4>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/syarat-ketentuan');?>">Terms and Conditions</a>
                  </div>
                  <div class="items-navbar-footer">
                    <a href="<?= base_url('/en/privasi');?>">Privacy Policy</a>
                  </div>
                </div>
              </div>
        ...
        $(document).ready(function() {
            $('#calendar').evoCalendar({                
                ...
                calendarEvents: [
                    ...
                    {id: <?= json_encode('EN'.$sc['schedule_id'].'X') ?>, name: <?= json_encode($sc['schedule_name_en'] ?? $sc['schedule_name'] ?? '') ?>, description: <?= json_encode(bxsea_plain_text($sc['schedule_desc_en'] ?? $sc['schedule_desc'] ?? '')) ?>, date: "<?= date_format(date_create($sc['schedule_date']), "F/d/Y")?>", type: "event", badge: <?= json_encode('<i class="fa-regular fa-clock"></i> '.esc($sc['schedule_time'] ?? '')) ?>},
                    <?php } ?>
                ],
            })
