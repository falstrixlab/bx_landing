...
<section class="schedule">
  <div class="container">
    ...
    <div class="note-schedule"><?= bxsea_render_html($ticketdescschedule[0]['masterdesc_title_en'] ?? 'Penguin Feeding Fun is now available as one of BXSea\'s most exciting extra experiences!');?></div>
