      ...
      <div class="owl-carousel owl-memories">
        <?php if (!empty($memories)): ?>
          ...
          <div class="memories-slide">
            <img src="<?= !empty($memory['memory_image']) ? bxsea_asset_url('moment_memory', $memory['memory_image'], 'assets/landing/image/bxsea_image_memories.png') : base_url('assets/landing/image/bxsea_image_memories.png'); ?>" alt="<?= esc($memory['memory_title_en'] ?? ($memory['memory_title_id'] ?? 'Visitor Memory')) ?>" class="img-fluid">
          </div>
          <?php endforeach; ?>
        <?php else: ?>
...
<section class="contactus2">
  <div class="container">
    <div class="title-contactus2">
      <h1>Book Now</h1>
      <p>Contact us to celebrate your special moment with us at BXSea Oceanarium!</p>
    </div>
