    ...
    <div class="premiun-package-flex">
          <div class="">
            <div class="card-premiumpackage">
              ...
              <div class="strength">
                <p class="amount-zone">18 Zones</p>
                <p> Spanning approximately 485 metres long, our Long Journey will bring you through countless zones equipped with the largest and most colourful freshwater fish, reptiles, amphibians, and more! Meet the entire BXSea biota at your own pace with the Long Journey. </p>
...
<section class="ticketing ticketfee-ticketing">
  ...
  <div class="container">
    <div class="head-title-ticketing"><h1>ADMISSION PRICES</h1></div>
    ...
    <div class="ticket-tab-panel is-active" id="work1">
      <div class="title-lityhide">
        <p><?= esc(bxsea_plain_text($homedescticketreguler[0]['masterdesc_desc_en'] ?? $homedescticketreguler[0]['masterdesc_desc'] ?? 'Max. purchase of 10 tickets per transaction'));?></p>
      </div>
                  ...
                  <div class="desc-card-ticketing">
                    ...
                    <div class="footer-card-ticketing">
                      <div class="link-buy-card-ticketing">
                        ...
                        <a href="<?= esc($tk['ticket_link']);?>" class="bg-blue-ticket" target="_blank" rel="noopener noreferrer">Buy Now</a>
                        <?php else: ?>
    ...
    <div class="ticket-tab-panel" id="work2">
      <div class="title-lityhide">
        <p><?= esc(bxsea_plain_text($homedescticketgroup[0]['masterdesc_desc_en'] ?? $homedescticketgroup[0]['masterdesc_desc'] ?? 'Minimum purchase of 20 tickets per transaction'));?></p>
      </div>
