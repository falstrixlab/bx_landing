...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Update Data Description <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                ...
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/ticketing/description/runupdate');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="masterdesc_title" value="<?= $rs["masterdesc_title"];?>" type="text" class="form-control"  placeholder="Enter Title ID" required="required"/>
                            <input type="hidden" name="masterdesc_id" value="<?= $rs["masterdesc_id"];?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description ID <span class="text-danger">*</span></label>
                            <textarea name="masterdesc_desc" class="form-control" placeholder="Enter Description ID" id="kt-ckeditor-1" rows="6"><?= $rs["masterdesc_desc"];?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Title EN <span class="text-danger">*</span></label>
                            <input name="masterdesc_title_en" value="<?= $rs["masterdesc_title_en"];?>" type="text" class="form-control"  placeholder="Enter Title EN" required="required"/>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description EN <span class="text-danger">*</span></label>
                            <textarea name="masterdesc_desc_en" class="form-control" placeholder="Enter Description EN" id="kt-ckeditor-2" rows="6"><?= $rs["masterdesc_desc_en"];?></textarea>
                        </div>
                        <div class="form-group">
