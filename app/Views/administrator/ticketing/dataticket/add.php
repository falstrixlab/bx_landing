...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5"> Data Ticket page </h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
            <a href="#" class="text-muted"> Data Ticket page </a>
            </li>
        </ul>
        <!--end::Breadcrumb-->
        </div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Add Data Ticket <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/ticketing/masterticket/runadd');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="ticket_title" type="text" class="form-control"  placeholder="Enter Title ID" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Title EN <span class="text-danger">*</span></label>
                            <input name="ticket_title_en" type="text" class="form-control"  placeholder="Enter Title EN" required="required"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="ticket_link" type="url" class="form-control" placeholder="https://ticket.bxsea.co.id/..."/>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Picture <span class="text-danger">*</span></label>
                            <input type="file" name="ticket_pict" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Price <span class="text-danger">*</span></label>
                            <input name="ticket_price" type="text" class="form-control"  placeholder="Enter Price" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Category <span class="text-danger">*</span></label>
                            <select class="form-control" name="ticket_category" required="required">
                                <option value="">Select Category</option>
                                <?php foreach($getdata AS $rs) {?>
                                    <option value="<?= $rs["ticketcat_id"];?>"><?= $rs["ticketcat_name"];?></option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group">
