...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
            <a href="#" class="text-muted"> Promotion page </a>
            </li>
        </ul>
        <!--end::Breadcrumb-->
        </div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Add Promotion <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/ticketing/promotion/runadd');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="promotion_title" type="text" class="form-control"  placeholder="Entry Title ID" required="required"/>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description ID <span class="text-danger">*</span></label>
                            <textarea name="promotion_desc" class="form-control" placeholder="Enter Description ID" id="kt-ckeditor-1" rows="6" ></textarea>
                        </div>
                        <div class="form-group">
                            <label>Title EN <span class="text-danger">*</span></label>
                            <input name="promoton_title_en" type="text" class="form-control"  placeholder="Entry Title EN" required="required"/>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description EN <span class="text-danger">*</span></label>
                            <textarea name="promotion_desc_en" class="form-control" placeholder="Enter Description ID" id="kt-ckeditor-2" rows="6" ></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Picture <span class="text-danger">*</span></label>
                            <input type="file" name="promotion_pict" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Link Promosi (URL)</label>
                            <input name="promotion_link" type="url" class="form-control" placeholder="https://"/>
                        </div>
                    </div>
