        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Edit Item – Know Section</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Edit Konten <em>Hal yang Perlu Diketahui</em></h3>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="card card-custom">
                        <form method="POST" action="<?= base_url('adminsite/visit/visitorinfo/runupdate') ?>" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="visitorinfo_section" value="rule">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Icon <small class="text-muted">(PNG/SVG transparan, ditampilkan di kartu)</small></label>
                                    ...
                                    <?php if (!empty($getdata['visitorinfo_icon'])): ?>
                                        <div class="mt-2">
                                            <img src="<?= base_url('assets/upload/visitorinfo/' . esc($getdata['visitorinfo_icon'])) ?>" alt="icon" style="max-height:60px;">
                                            <p class="text-muted mt-1 font-size-sm"><?= esc($getdata['visitorinfo_icon']) ?></p>
                                        </div>
                                    <?php endif; ?>
                                    <input type="hidden" name="visitorinfo_icon_temp" value="<?= esc($getdata['visitorinfo_icon'] ?? '') ?>">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= base_url('adminsite/visit/visitorinfo/know') ?>" class="btn btn-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
