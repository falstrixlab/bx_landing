        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Tambah Item – Know Section</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                    <div class="card-title">
                        <h3 class="card-label">Tambah Konten <em>Hal yang Perlu Diketahui</em></h3>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="card card-custom">
                        <form method="POST" action="<?= base_url('adminsite/visit/visitorinfo/know/runadd') ?>" enctype="multipart/form-data">
