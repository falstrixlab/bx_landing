...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <!-- <div class="card-toolbar">
            ...
            <a href="<?= base_url('adminsite/visit/description/add');?>" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-icon btn-sm btn-light-warning pulse pulse-warning mr-5" href="<?= base_url('adminsite/visit/description/update/'.$rs["masterdesc_id"])?>">
                        <i class="flaticon-edit-1 icon-lg" title="Edit Content"></i>
                        <span class="pulse-ring"></span>
                    </a>
                    <!-- <a onclick="return confirm('Are you sure you want to delete this data ?')" class="btn btn-sm btn-icon btn-light-danger pulse pulse-danger mr-5" href="<?= base_url('adminsite/visit/description/delete/'.$rs["masterdesc_id"])?>">
