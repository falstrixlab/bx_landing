...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <table class="table table-bordered table-checkable" id="kt_datatable">
            ...
            <tr>
                <td><?= $i;?></td>
                <td><?= $rs["homefiturslide_title"];?></td>
                <td><?= $rs["homefiturslide_title_en"];?></td>
                <td><?= $rs["homefiturslide_shortdesc"];?></td>
                <td><?= $rs["homefiturslide_shortdesc_en"];?></td>
                <td>
                    <center>
                ...
                <td><?= $rs["homefitureslide_link"];?></td>
                <td>
                    <a class="btn btn-icon btn-sm btn-light-warning pulse pulse-warning mr-5" href="<?= base_url('adminsite/home/fiturslide/update/'.$rs["homefiturslide_id"])?>">
