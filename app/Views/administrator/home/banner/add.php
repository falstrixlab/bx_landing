...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Add Banner <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/home/banner/runadd');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleTextarea">Banner Image <span class="text-danger">*</span></label>
                            <input type="file" name="homebanner_pict" class="form-control">
                        </div>
                    </div>
