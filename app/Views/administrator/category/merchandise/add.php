...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Add Data Merchandise Category <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/category/merchandisecategory/runadd');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="merchandisecat_name" type="text" class="form-control"  placeholder="Enter Merchandise Category Name" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Merchandise Category Name EN<span class="text-danger">*</span></label>
                            <input name="merchandisecat_name_en" type="text" class="form-control"  placeholder="Enter Merchandise Category Name" required="required"/>
                        </div>
                    </div>
