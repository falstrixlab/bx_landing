...
<div class="subheader py-2 py-lg-6  subheader-solid " id="kt_subheader">
    ...
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold my-1 mr-5"> Show page </h5>
        <!--end::Page Title-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
            <a href="#" class="text-muted"> Show page </a>
            </li>
        </ul>
        <!--end::Breadcrumb-->
        </div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-title">
            <h3 class="card-label">Add Show <span class="d-block text-muted pt-2 font-size-sm">sorting & pagination remote datasource</span>
            </h3>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/explore/show/runadd');?>" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="show_title" type="text" class="form-control"  placeholder="Entry Title ID" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Title EN <span class="text-danger">*</span></label>
                            <input name="show_title_en" type="text" class="form-control"  placeholder="Entry Title EN" required="required"/>
                        </div>
                        <div class="form-group">
                            <label>Desc ID <span class="text-danger">*</span></label>
                            <textarea name="show_desc" class="form-control" placeholder="Entry Desc ID" rows="6"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleTextarea">Poster <span class="text-danger">*</span></label>
                            <input type="file" name="show_poster" class="form-control">
                        </div>
                    </div>
