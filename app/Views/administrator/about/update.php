    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
            ...
            <div class="card card-custom">
                <!--begin::Form-->
                <form method="POST" action="<?= base_url('adminsite/about/runupdate');?>" enctype="multipart/form-data">
                    ...
                    <div class="card-body" style="background-color:#F3F6F9;">
                        <div class="form-group">
                            ...
                            <input type="text" name="about_title" class="form-control" value="<?= $rs["about_title"];?>"/>
                            <input type="hidden" name="about_id" value="<?= $rs["about_id"];?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description ID <span class="text-danger">*</span></label>
                            <textarea name="about_desc" class="form-control" placeholder="Enter Description ID" id="kt-ckeditor-1" rows="6"><?= $rs["about_desc"];?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Title EN <span class="text-danger">*</span></label>
                            <input type="text" name="about_title_en" class="form-control" value="<?= $rs["about_title_en"];?>"/>
                        </div>
                        <div class="form-group">
                            <label for="exampleTextarea">Description EN <span class="text-danger">*</span></label>
                            <textarea name="about_desc_en" class="form-control" placeholder="Enter Description ID" id="kt-ckeditor-2" rows="6"><?= $rs["about_desc_en"];?></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="image-input image-input-outline" id="kt_image_1">
                                ...
                                <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change logo">
                                    ...
                                    <input type="file" name="about_pict" accept=".png, .jpg, .jpeg">
                                    <input type="hidden" value="<?= $rs["about_pict"];?>" name="about_pict_temp">
                                </label>
