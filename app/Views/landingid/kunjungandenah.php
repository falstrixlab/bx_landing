...
<?php
$mapPreviewAsset = bxsea_design_asset('visit', 'map_preview', 'assets/landing/image/FULL BXSea MAP [Revised]-1.png');
$mapDownloadAsset = bxsea_design_asset('visit', 'map_download', 'assets/landing/image/FULL BXSea MAP [Revised]_compressed.pdf');
$mapHeroAsset = bxsea_design_asset('visit', 'hero_map', 'assets/landing/image/bxsea_image_bg-visitor.png');
?>

<section class="sectionBanner">
  <div class="hero-wrap2">
    <div class="hero-image2">
      <img src="<?= $mapHeroAsset; ?>" alt="">
    </div>
    <div class="container">
