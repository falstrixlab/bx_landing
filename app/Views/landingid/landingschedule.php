        ...
        $(document).ready(function() {
            $('#calendar').evoCalendar({                
                ...
                calendarEvents: [
                    ...
                    {id: <?= json_encode('ID'.$sc['schedule_id'].'X') ?>, name: <?= json_encode($sc['schedule_name'] ?? '') ?>, description: <?= json_encode(bxsea_plain_text($sc['schedule_desc'] ?? '')) ?>, date: "<?= date_format(date_create($sc['schedule_date']), "F/d/Y")?>", type: "event", badge: <?= json_encode('<i class="fa-regular fa-clock"></i> '.esc($sc['schedule_time'] ?? '')) ?>},
                    <?php } ?>
                ],
            })
